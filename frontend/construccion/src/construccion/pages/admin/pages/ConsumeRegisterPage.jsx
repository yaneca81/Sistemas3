...
export const ConsumeRegisterPage = () => {
  ...
  const handleSave = async (consume) => {
    await saveConsume(consume);
  };
  ...
  return (
    <div className='container mx-auto p-6'>
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-gray-700">Registro de Uso</h1>
